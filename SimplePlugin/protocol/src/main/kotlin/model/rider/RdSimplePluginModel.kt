...
@Suppress("unused")
object RdSimplePluginModel : Ext(SolutionModel.Solution) {
    ...
    init {
        setting(Kotlin11Generator.Namespace, "com.jetbrains.rider.plugins.simpleplugin.model")
        setting(CSharp50Generator.Namespace, "Rider.Plugins.SimplePlugin.Model")
